...
_DEFAULT_CONFIG = {'PATH': '.',
                   'ARTICLE_DIR': '',
                   'ARTICLE_EXCLUDES': ('pages','blog'),
                   'PAGE_DIR': 'pages',
                   'PAGE_EXCLUDES': (),
                   'BLOG_DIR': 'blog',
                   'BLOG_EXCLUDES': ('pages','blog'),
                   'THEME': DEFAULT_THEME,
                   'OUTPUT_PATH': 'output/',
                   'MARKUP': ('rst', 'md'),
                   'STATIC_PATHS': ['images', ],
                   ...
                   'BLOG_URL': '{date:%Y}/{date:%m}/{date:%d}/{slug}.html',
                   'BLOG_SAVE_AS': 'blog/{date:%Y}/{date:%m}/{date:%d}/{slug}.html',
                   'BLOG_LANG_URL': 'blog/{slug}-{lang}.html',
                   'BLOG_LANG_SAVE_AS': 'blog/{slug}-{lang}.html',
                   'ENTRIES_URL': 'blog/{slug}.html',
                   'ENTRIES_SAVE_AS': 'blog/index.html',
                   'ENTRIES_LANG_URL': 'blog/{slug}-{lang}.html',
                   'ENTRIES_LANG_SAVE_AS': 'blog/{slug}-{lang}.html',
                   ...
                   'DIRECT_TEMPLATES': ('index', 'entries', 'tags', 'categories', 'archives'),
                   'EXTRA_TEMPLATES_PATHS': [],
                   'PAGINATED_DIRECT_TEMPLATES': ('index', 'entries', ),
